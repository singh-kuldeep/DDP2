...
class eulerflux
{
	...
	eulerflux(vector<double>& ConservedVariable)
	{
		...
		EulerFluxX[1] = (pow(ConservedVariable[1],2)/ConservedVariable[0]) +
		Pressure ;     
		EulerFluxX[2] = ConservedVariable[1]*ConservedVariable[2] / 
		ConservedVariable[0] ; 
		EulerFluxX[3] = ConservedVariable[1]*ConservedVariable[3] /
		ConservedVariable[0] ;
		EulerFluxX[4] = ((ConservedVariable[4] + Pressure)*ConservedVariable[1])
		/ConservedVariable[0] ;

		EulerFluxY[0] = ConservedVariable[2] ;
		EulerFluxY[1] = ConservedVariable[1]*ConservedVariable[2] /
		ConservedVariable[0] ; 
		EulerFluxY[2] = (pow(ConservedVariable[2],2)/ConservedVariable[0]) + 
		Pressure ;     
		EulerFluxY[3] = ConservedVariable[2]*ConservedVariable[3] /
		ConservedVariable[0] ;
		EulerFluxY[4] = ((ConservedVariable[4] + Pressure)*ConservedVariable[2])
		/ConservedVariable[0] ;

		EulerFluxZ[0] = ConservedVariable[3] ;
		EulerFluxZ[1] = ConservedVariable[1]*ConservedVariable[3] /
		ConservedVariable[0] ; 
		EulerFluxZ[2] = ConservedVariable[2]*ConservedVariable[3] /
		ConservedVariable[0] ;
		EulerFluxZ[3] = (pow(ConservedVariable[3],2)/ConservedVariable[0]) + 
		Pressure ;     
		EulerFluxZ[4] = ((ConservedVariable[4] + Pressure)*ConservedVariable[3])
		/ConservedVariable[0] ;
