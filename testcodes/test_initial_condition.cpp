...
double find_throat_area(
	...
	int & throat_location)
{
	double throat_area = 1000; /** \param throat_area Area of the throat*/
...
int main()
{
   ...
   yup.close();
	...
	#if 1
	//case (2) For solution to converge faster putting value by theory  
	...
	for (int i =throat_location+1; i < UpperCoordinates.size(); ++i) 
	{
		// for (int j =0; j < Nj; ++j)
		// {
		// 	for (int k =0; k < Nk; ++k)
		// 	{
				...
				cout << Mach << endl;
				// cout << VelocityMagnitude << endl;
				// cout << throat_location << endl;	
				// cout << FlowAngle*180/acos(-1) << endl;
