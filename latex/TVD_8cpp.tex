...
{\ttfamily \#include \char`\"{}grid\+\_\+ideal\+\_\+nozzle.\+h\char`\"{}}\\*
...
\end{DoxyParams}
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000008}{Bug}]Every time simulation starts from first iteration. So, to save the simulation it is good to start from the last solution as the initial condition \end{DoxyRefDesc}
...
\end{DoxyParams}
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000009}{Bug}]Local time step needs to be used to reduce the simulation time \end{DoxyRefDesc}
